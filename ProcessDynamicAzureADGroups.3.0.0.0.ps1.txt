...
.EXAMPLE 
CreateDynameicAzureADGroups.ps1 - Inputfile "C:Data\Inpute\CreateDyanmicAzureGroups.csv" - LogFilesPath "C:Data\Output\"
...
.EXAMPLE 
CreatedDyanmicAzureADGroups.ps1 -InputFile "C:\Data\Input\CreateDynamicAzureADGroups.csv"
...
$todaydate= Get-Date -Format "MM_dd_yyyy_hh_mm_ss"
...
Function Main()
{
	...
	$context = Connect-MgGraph -Scopes "User.ReadWrite.All","Group.ReadWrite.All"
	...
	Write-Host "************************"-Fbregroundcolor Yellow
	...
	Write-Host "Total groups updated: $($processedGroups.TotalGroupsUpdated)" -ForeqroundColor Yellow
	Write-Host "Total groups failed: $($processedGroups.TotalGroupsFailed)" -ForegroundColor Yellow
	Write-Host "Total groups processed: $($processedGroups.TotalGroupsProcessed)" -ForeqroundColor Yellow
